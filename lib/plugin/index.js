...
class MapLeafletChartPlugin extends _core.ChartPlugin {
  constructor() {
    const metadata = new _core.ChartMetadata({
      description: 'Map Leaflet',
      name: (0, _core.t)('Map Leaflet'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../MapLeaflet'))),
      metadata,
...
exports.default = MapLeafletChartPlugin;